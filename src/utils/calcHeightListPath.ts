import { APP_BAR_HIEGHT, CONTAINER_WRAPPER_VERTICAL_PADDING, LIST_PATH_VERTICAL_PADDING, SEARCH_INPUT } from 'constants/screen';
...
;	const heightWithoutLaout = height - (APP_BAR_HIEGHT + (CONTAINER_WRAPPER_VERTICAL_PADDING * 2));
	...
	return (heightWithoutLaout / coficient) - (LIST_PATH_VERTICAL_PADDING + SEARCH_INPUT + listPaddingMobOfTab);
};